...
from total_schemas import IPCCodeInput,IPCDetailInfo,IPCKeywordInput,IPCMainDescription,PatentSearchInput,PatentClaimSnippet,PatentSearchResult,PatentSearchOutput
